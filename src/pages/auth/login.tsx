...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-softLavender flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div className="flex flex-col items-center">
          <img src={TitleLogo} alt="Colare Logo" className="h-12 w-auto mb-6" />
