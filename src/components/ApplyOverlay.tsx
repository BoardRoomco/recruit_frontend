    ...
    >
      ...
      >
        ...
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-6 text-white">Apply for {jobTitle}</h2>
          
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              <label htmlFor="coverLetter" className="block text-sm font-medium text-white mb-2 text-left">
